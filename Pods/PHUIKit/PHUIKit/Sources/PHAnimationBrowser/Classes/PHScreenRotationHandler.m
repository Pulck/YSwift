...
BOOL PHValidDeviceOrientation(UIDeviceOrientation orientation) {
...
CGFloat PHRotationAngle(UIDeviceOrientation startOrientation, UIDeviceOrientation endOrientation) {
...
@interface PHScreenRotationHandler ()
@property (nonatomic, assign) BOOL rotating;
@property (nonatomic, assign) UIDeviceOrientation currentOrientation;
@end

@implementation PHScreenRotationHandler{
    __weak PHAnimationImageBrowser *_browser;
...
- (BOOL)supportedOfOrientation:(UIDeviceOrientation)orientation {
    if (!PHValidDeviceOrientation(orientation)) return NO;
...
- (void)orientationWillChangeWithExpectOrientation:(UIDeviceOrientation)orientation centerCell:(UICollectionViewCell<YBIBCellProtocol> *)centerCell {
    ...
    for (id<PHToolViewHandler> handler in _browser.toolViewHandlers) {
...
- (void)deviceOrientationDidChangeNotification:(NSNotification *)note {
    ...
    CGFloat angleStatusBarToExpect = PHRotationAngle(statusBarOrientation, expectOrientation);
    CGFloat angleCurrentToExpect = PHRotationAngle(_currentOrientation, expectOrientation);
